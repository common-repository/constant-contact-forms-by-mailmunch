  ...
  var nonces = mailmunch_nonces;
    ...
    $('.delete-widget').click(function() {
      ...
      $.ajax({
        url: ajaxurl,
        type: 'POST',
        data: {action: 'delete_widget', widget_id: $(this).data('widget-id'), nonce: nonces.delete_widget},
        dataType: 'json',
      ...
      $.ajax({
        url: ajaxurl,
        type: 'POST',
        data: {action: 'change_email_status', email_status: $(this).data('email-status'), email_id: $(this).data('email-id'), nonce: nonces.change_email_status},
        dataType: 'json',
        success: function(data) {
          if (data.success) {
      ...
      $.ajax({
        url: ajaxurl,
        type: 'POST',
        data: {action: 'delete_email', email_id: $(this).data('email-id'), nonce: nonces.delete_email},
        dataType: 'json',
        success: function(data) {
          if (data.success) {
						$(this).parents('tr').slideUp();
    ...
    $('#signup_form').submit(function(e) {
      ...
      var data = {
        ...
        action: 'sign_up',
        mailmunch_signup_nonce: nonces.sign_up
      };
    ...
    $('#signin_form').submit(function(e) {
      ...
      var data = {
        ...
        password: $(this).find('input[name=password]').val(),
        action: 'sign_in',
        mailmunch_signin_nonce: nonces.sign_in // Add nonce for sign-in action
      };
